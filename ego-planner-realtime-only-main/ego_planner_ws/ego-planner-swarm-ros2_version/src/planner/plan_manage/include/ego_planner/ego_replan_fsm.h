...
namespace ego_planner
{
  ...
  private:
    ...
    bool use_odom_for_replan_start_;
    bool use_odom_for_finish_check_;
    ...
    int current_wp_;
    int detour_side_preference_{0}; // preferred lateral sign for obstacle bypass: +1/-1, 0 means unset
    int detour_preference_clear_count_{0};
